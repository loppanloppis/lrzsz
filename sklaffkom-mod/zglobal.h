...
# endif
#endif
#define HOWMANY 1  /* added 2025-07-25 PL  */
#ifndef __P
...
char *strchr (), *strrchr ();
# ifndef HAVE_MEMCPY
#  /* define memcpy(d, s, n) bcopy ((s), (d), (n)) */  /* We don't need these in 2025 PL 2025-07-23 */
#  /* define memmove(d, s, n) bcopy ((s), (d), (n)) */ /* Also not needed */ 
# endif
#endif
